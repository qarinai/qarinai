  ...
  template: ` <div class="layout-topbar">
    <div class="layout-topbar-logo-container">
      ...
      <a class="layout-topbar-logo" routerLink="/">
        <svg class="logo-icon" id="Layer_1" xmlns="http://www.w3.org/2000/svg" version="1.1" viewBox="0 0 1000 1000">
          <defs>
        ...
        <div class="inline-flex items-end">
          <span class="text-gradient">Qarīn.ai</span>
          <span class="text-sm text-muted-color mx-4 min-w-fit">Your AI Companion</span>
        </div>
      </a>
    </div>
    ...
    <div class="layout-topbar-actions">
      <div class="layout-config-menu">
        ...
        <div class="relative">
          ...
          <button type="button" class="layout-topbar-action ml-4" pStyleClass="@next" (click)="menu.toggle($event)">
    ...
    this.items = [
      {
        ...
        icon: 'pi pi-key',
        command: () => {
          router.navigate(['/pages/personal-access-tokens']);
        }
      },
      {
        label: 'Logout',
